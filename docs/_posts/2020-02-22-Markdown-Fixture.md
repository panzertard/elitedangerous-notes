...
<img src="image.png" width="182" align="left"><br><br><br><br><br><br><br><br>
...
| zebra stripes | are neat      |  ![img](.\img.png)   |
...
Here's a simple block, you should see 'foo' only:
...
Now, nested. You can't see the first wrapping 'div':
...
This should just be an HTML comment (invisible to you):

<!-- Comment -->

Multiline comment, still invisible:
